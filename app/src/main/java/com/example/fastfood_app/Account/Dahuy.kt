...
@Composable
fun dahuy(navController: NavHostController) {
    val orders = listOf(
        Order("Mỳ", "29 Nov, 01:20 pm", "2 items", "20.000đ","Đã huỷ", R.drawable.myy),
        Order("Pizza", "30 Nov, 02:30 pm", "1 item", "15.000đ","Đã huỷ", R.drawable.pizza),
        Order("Xúc Xích Đức", "01 Dec, 12:00 pm", "3 items", "25.000đ","Đã huỷ", R.drawable.xucxich)
    )
